...
set _xil_proj_name_ "FSM_Digital_Lock_"
...
set script_file "FSM_Digital_Lock.tcl"
...
set files [list \
 [file normalize "${origin_dir}/src/digital_lock.sv"] \
 [file normalize "${origin_dir}/src/pulse_gen.sv"] \
 [file normalize "${origin_dir}/src/debounce.vhd"] \
 [file normalize "${origin_dir}/src/single_pulse_detector.vhd"] \
 [file normalize "${origin_dir}/src/digital_lock_top.sv"] \
]
add_files -norecurse -fileset $obj $files

# Set 'sources_1' fileset file properties for remote files
set file "$origin_dir/src/digital_lock.sv"
set file [file normalize $file]
set file_obj [get_files -of_objects [get_filesets sources_1] [list "*$file"]]
set_property -name "file_type" -value "SystemVerilog" -objects $file_obj

set file "$origin_dir/src/pulse_gen.sv"
set file [file normalize $file]
set file_obj [get_files -of_objects [get_filesets sources_1] [list "*$file"]]
set_property -name "file_type" -value "SystemVerilog" -objects $file_obj
...
set file "$origin_dir/src/digital_lock_top.sv"
set file [file normalize $file]
set file_obj [get_files -of_objects [get_filesets sources_1] [list "*$file"]]
set_property -name "file_type" -value "SystemVerilog" -objects $file_obj
...
set obj [get_filesets sources_1]
set_property -name "top" -value "digital_lock_top" -objects $obj
...
set file "[file normalize "$origin_dir/constr/FSM-Digital-Lock-Zybo-Z7.xdc"]"
set file_added [add_files -norecurse -fileset $obj [list $file]]
set file "$origin_dir/constr/FSM-Digital-Lock-Zybo-Z7.xdc"
set file [file normalize $file]
...
set files [list \
 [file normalize "${origin_dir}/sim/digital_lock_top_tb.sv"] \
]
add_files -norecurse -fileset $obj $files

# Set 'sim_1' fileset file properties for remote files
set file "$origin_dir/sim/digital_lock_top_tb.sv"
set file [file normalize $file]
...
set obj [get_filesets sim_1]
set_property -name "top" -value "digital_lock_top_tb" -objects $obj
